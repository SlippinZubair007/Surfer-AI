        ...
        <div className="absolute -top-10 left-0 w-40 h-40 border-l-2 border-t-2" />
         ...
         <div className=" top-0 left-5 lg:col-span-7 space-y-8 relative">
           <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div>
                  <span className="text-foreground">Up Your Body</span>
                </div>
                <div className="pt-2">
                ...
                <div className="pt-2">
                  ...
                  <span className="text-primary"> Surfer.AI</span>
                </div>
              </h1>
              ...
              <div className="h-px w-full bg-gradient-to-r from-primary via-secondary to-primary opacity-50"></div>
               ...
               <p className="text-xl text-muted-foreground w-2/3">
                Talk to our surfer.AI and power up your fitness levels through our personalized diet plans and workout routines
                designed just for you.
              </p>
              <p className="text-sm color-grey  text-primary"> 
                Do not mistake true power for brute force
              </p>
